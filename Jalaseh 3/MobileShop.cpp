...
class Phone {
 public:
  Phone(string model, string brand, int price, int cameraResolution,
        string color);
...
Phone::Phone(string _model, string _brand, int _price, int _cameraResolution,
             string _color) {
  model = _model;
  brand = _brand;
  price = _price;
...
inline string Phone::getModel(void) { return model; }
inline string Phone::getBrand(void) { return brand; }
inline int Phone::getPrice(void) { return price; }
inline int Phone::getResolution(void) { return cameraResolution; }
inline string Phone::getColor(void) { return color; }
