...
BinarySearchTree::Node *BinarySearchTree::insert(int data, BinarySearchTree::Node *node)
{
    if (node == NULL)
    {
...
BinarySearchTree::Node *BinarySearchTree::remove(int data, BinarySearchTree::Node *node)
{
    if (node == NULL)
    {
        return NULL;
...
BinarySearchTree::Node *BinarySearchTree::deleteAllNodes(BinarySearchTree::Node *node)
{
    if (node == NULL)
    {
        return NULL;
...
BinarySearchTree::Node *BinarySearchTree::search(int data, BinarySearchTree::Node *node)
{
    if (node == NULL)
    {
        return NULL;
...
BinarySearchTree::Node *BinarySearchTree::Node::getRight(void)
{
    return right;
}
BinarySearchTree::Node *BinarySearchTree::Node::getLeft(void)
{
    return left;
}
int BinarySearchTree::Node::getData(void)
{
    return data;
}
...
void BinarySearchTree::Node::setData(int d)
{
    data = d;
}