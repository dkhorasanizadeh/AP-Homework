...
Login::Login(QWidget *parent) : QMainWindow(parent) {
  ...
  enterLogin = new QShortcut(QKeySequence(Qt::Key::Key_Enter), this,
                             SLOT(LoginButtonPressed()));
...
void Login::openLogin(void) { this->show(); }
...
void Login::LoginButtonPressed(void) {
  ...
  QMessageBox message;
  if (usernameLineEditText.length() == 0 ||
      passwordLineEditText.length() == 0) {
